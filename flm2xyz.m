function varargout=flm2xyz(flmcosi,degrees,c11cmn,lmax)
% [r,lon,lat]=FLM2XYZ(flmcosi,degrees,c11cmn,lmax)
%
% Compute an outer source gradient spherical harmonic vector field 
% (coefficents for r, theta, and phi) from coefficients of the Flm 
% given as [l m Ccos Csin] (not necessarily starting from zero, but sorted)
% with degree resolution 'degres' [default: approximate Nyquist degree].
%
% Using 4*pi-normalized real spherical harmonics
%
% INPUT:
%
% flmcosi   Matrix listing l,m,cosine and sine expansion coefficients for
%           Flm
% degrees    Longitude/ latitude spacing, in degrees [default: Nyquist] OR
...
%
% See also ELM2xyz, BLMCLM2XYZ, PLM2XYZ
%
...
% Start with transforming flm into plm & blm.
% Generate elmcosi. Remember: It has the L=0 coefficient
elmcosi=[0 0 0 0;flmcosi(:,1:2) zeros(size(flmcosi(:,3:4)))];
